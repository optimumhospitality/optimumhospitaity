import WhyUsBG from "../../assets/image/vertise-ai/WhyUsBG.webp"

export default function WhyOptimumVertise() {
    return (
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-[100px]">
                ...
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[48px] font-[500] text-[#23283C] mb-4 leading-tight">
                        Why Optimum Hospitality and Vertize
                    </h2>
                ...
                >
                    <div className="flex flex-col lg:flex-row lg:max-h-[534px]">
                        ...
                        <div className="w-full lg:w-1/2 p-6 lg:pt-8 lg:pr-28">
                            <h3 className="text-2xl sm:text-3xl lg:text-[32px] font-[400] text-[#23283C] mb-4" style={{ lineHeight: '1.1' }}>
                                Boutique city hotel (80 rooms)
                            </h3>

                            <div className="mb-4">
                                <h4 className="text-lg font-[500] text-[#000000] mb-0" style={{ lineHeight: '1.2' }}>
                                    Focus
                                </h4>
                                <p className="text-[#000000] font-[300] text-[18px]" style={{ lineHeight: '1.3' }}>
                                    AI powered pre arrival and in stay upsell, plus automated FAQ handling.
                                </p>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-[#000000] font-[300] text-[18px]" style={{ lineHeight: '1.3' }}>
                                    Manual upsell emails, high call volume to front office, no central tracking.
                                </p>
                            </div>

                            <div className="mb-5">
                                <h4 className="text-lg font-[500] text-[#2A2E3C] mb-2" style={{ lineHeight: '1.2' }}>
                                    Typical result after 90 days
                                </h4>
                                <ul className="space-y-1">
                                    <li className="flex items-start gap-2">
                                        <span className="text-[#000000]">•</span>
                                        <span className="text-[#000000] font-[300] text-[18px]" style={{ lineHeight: '1.3' }}>
                                    ...
                                    <li className="flex items-start gap-2">
                                        <span className="text-[#000000]">•</span>
                                        <span className="text-[#000000] font-[300] text-[18px]" style={{ lineHeight: '1.3' }}>
                                            around 35 percent of routine questions handled entirely by Al agents.
                                        </span>
                                    </li>
                                </ul>
                            </div>
