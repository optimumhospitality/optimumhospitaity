    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-4 min-[500px]:px-3 sm:px-4 min-[750px]:px-6 md:px-8 lg:px-10 xl:px-[40px]">
        ...
        <div className="mb-3 min-[500px]:mb-2 sm:mb-3 min-[750px]:mb-4">
          <nav className="flex items-center gap-1.5 min-[500px]:gap-1 sm:gap-1.5 min-[750px]:gap-2 text-white/80 text-[14px] min-[500px]:text-[14px] sm:text-[14px] min-[750px]:text-[16px] md:text-[24px]">
        ...
        <div className="flex flex-col min-[500px]:flex-row min-[500px]:items-end min-[500px]:justify-between gap-4 min-[500px]:gap-4 sm:gap-5 min-[750px]:gap-6">
          ...
          <div className="max-w-full min-[500px]:flex-1">
            ...
            {/* Subtitle */}
            <p className="text-white/95 text-[14px] min-[500px]:text-[14px] sm:text-[14px] min-[750px]:text-[14px] md:text-[16px] lg:text-[18px] xl:text-xl leading-relaxed mb-2 min-[500px]:mb-1.5 sm:mb-2 min-[750px]:mb-3">
              {subtitle}
            </p>
          </div>
        </div>
