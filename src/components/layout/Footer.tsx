          ...
          <div className="bg-secondary rounded-2xl sm:rounded-3xl px-5 sm:px-6 max-lg:px-6 lg:px-16 py-8 sm:py-10 md:py-12 lg:py-16 overflow-hidden">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 sm:gap-8">
              ...
              <div className="flex justify-center lg:justify-end flex-shrink-0">
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 md:px-6 md:py-3.5 bg-primary text-white text-sm sm:text-sm md:text-base lg:text-[16px] font-[400] rounded-md hover:bg-primary/90 transition-colors"
                >
